<template>
    ...
    <div class="header">
        <!-- Get Started -->
        <div>
            <img src="../assets/images/start.svg" alt="Get Started" />
            <button @clickgotoGetStarted>Get Started</button>
        </div>
    ...
    <div class="features">
        ...
        <span class="exit" @click="reset()">Exit</span>
    </div>
    <div class="up">
        <div class="icon">
            <img
...
export default {
    ...
    methods: {
        ...
        addRandomNumber() {
            // 如果数组空值元素个数 小于 要添加的随机数个数, 弹窗提示游戏结束
            // 即数组非空值元素个数 大于 所有元素个数 减去 要添加的随机数个数
            if (
...
.features {
    ...
    margin: 0 auto 20px;
    grid-template-areas:
        "firstRowFirstColumn" "firstRowSecondColumn" "firstRowThirdColumn" "firstRowFourColumn"
        "secondRowFirstColumn" "secondRowSecondColumn" "secondRowThirdColumn" "secondRowFourColumn";
    // 行高
