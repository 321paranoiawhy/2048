<template>
    ...
    <img src="../assets/images/MdiArrowUpThinCircleOutline.svg" alt="Up" />
    <img src="../assets/images/MdiArrowDownThinCircleOutline.svg" alt="Down" />
...
export default {
    ...
    setup() {
        ...
        let reset = () => {
            return (array = this.initializedArray());
        };
        return {
            testArray,
            reset,
