...
export default {
    ...
    methods: {
        ...
        calculateScores() {
            ...
            // 数字和重复次数
            // 使用 numbersAndRepeatTimes.get(number) 获取 number 重复次数
            let numbersAndRepeatTimes = new Map(
            ...
            for (let i = 0; i <= this.winNumber; ) {
                this.array.flat();
            }
            [2, 2, 3, 4, 5, 5, 6, 6, 6, 6].filter((x) => x === 2).length;
        },
        // 数组转置
