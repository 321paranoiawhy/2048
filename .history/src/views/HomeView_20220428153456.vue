<template>
    ...
    <div class="container">
        <div class="setup">
            ...
            <input type="text" v-model="initialFillableNumbers" />
            <!-- 初始数字概率 -->
            <label>PIN --- Probability of Initial Number(s):</label>
            <input type="text" v-model="numberProbabilityArray" />
            <!-- 每次移动后新增数字个数 -->
            <label>NN --- New Number(s):</label>
            <input type="text" v-model="newNumbers" />
            <!-- 获胜数字 -->
            <label>WN --- Win Number:</label>
            <input type="text" v-model="winNumber" />
            <!-- Play -->
            <div class="play">
                <img
