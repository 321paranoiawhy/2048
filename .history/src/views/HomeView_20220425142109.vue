<template>
    ...
    <div>
        <img src="../assets/images/CarbonUndo.svg" alt="Undo" />
        <img src="../assets/images/CarbonReset.svg" alt="Restart" />
    </div>
    <div class="container">
    ...
    <img src="../assets/images/CarbonArrowDown.svg" alt="Down" />
    ...
    <div>Press UpArrow or W</div>
    <div>Press DownArrow or S</div>
