<template>
    ...
    <div class="container">
        <div class="setup">
            <!-- 进制 -->
            <label>n --- Base:</label>
            <input type="text" @focus="removeKeyDown()" @blur="addKeyDown()" />
            <!-- 网格大小 -->
            <label>s --- Size:</label>
            <input v-model="size" />
            <!-- 初始数字 -->
            <label>IN --- Initial Number(s):</label>
            <input v-model="initialFillableNumbers" />
            <!-- 初始数字概率 -->
            <label>PIN --- Probability of Initial Number(s):</label>
            <input v-model="numberProbabilityArray" />
            <!-- 每次移动后新增数字个数 -->
            <label>NN --- New Number(s):</label>
            <input v-model="newNumbers" />
            <!-- 获胜数字 -->
            <label>WN --- Win Number:</label>
            <input v-model="winNumber" />
            <!-- Play -->
            <div class="play">
                <img
