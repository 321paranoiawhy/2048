...
export default {
    ...
    methods: {
        randomACoupleOfNumbers() {
            ...
            let numberOne = Math.round(Math.random() * this.size);
            let numberTwo = Math.round(Math.random() * this.size);
        ...
        randomTwoNumbers(length) {
            ...
            for (let i = 0; i < length; i++) {
                this.randomACoupleOfNumbers();
                tempArray.push(this.randomACoupleOfNumbers());
            }
            return tempArray;
        },
